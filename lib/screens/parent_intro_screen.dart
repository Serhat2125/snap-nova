    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 22),
          _benefitRow(context, '⏱️', 'Günlük çalışma süresi',
              'Hangi derste ne kadar odaklandı?'),
          _benefitRow(context, '📊', 'Ders bazlı başarı',
              'Konu konu doğru/yanlış dağılımı, zaman içinde gelişim.'),
          _benefitRow(context, '📸', 'Fotoğraf soru sayısı',
              'Kaç soru yöneltti, hangileri pratiğe döndü?'),
          _benefitRow(context, '🧠', 'AI içgörü',
              'Yapay zeka çocuğun haftalık performansını yorumlar.'),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 22),
          _step(context, 1,
              'Çocuk profilinden kodu üretir',
              'Çocuğun "Profil → Ebeveyn Bağla" ekranından 6 haneli kod oluşturur.'),
          _step(context, 2,
              'Sen panelinden kodu girersin',
              'Ebeveyn Paneli → "Çocuk Ekle" → kodu yapıştır.'),
          _step(context, 3,
              'Bağlantı kurulur, panel açılır',
              'Tüm aktiviteler, ödevler, AI içgörüler senin için hazır.'),
